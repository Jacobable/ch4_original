...
public class BoardDaoImplTest {
    ...
    public void searchSelectPageTest() throws Exception {
    	...
    	for (int i = 1; i <=20; i++) {
    		BoardDto baorDto = new BoardDto("title"+i,"content~~~", "writer~~~");
			boardDao.insert(baorDto);
		}
    ...
    public void searchResultCntTest() throws Exception {
    	...
    	assertTrue(count==2); // 1~20, title2 title20
    }
    ...
    public void insertTestData() throws Exception{
    	boardDao.deleteAll();
    	for (int i = 0; i < 250; i++) {
    		BoardDto boardDto = new BoardDto("title"+i, "no content", "1111");
